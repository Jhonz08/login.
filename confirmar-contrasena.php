    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                ...
                <form id="formulario_cambiar_contrasena">
                    <!-- Estructura del formulario -->
                    <fieldset>

                        <legend class="center">Actualizar Contraseña</legend>
                        ...
                        <div class="row">
                            <div class="col-xs-8 col-xs-offset-2">
                                <div class="spacing-2"></div>
                                <button type="button" class="btn btn-primary btn-block" name="button" id="cambiar-contrasena">Confirmar</button>
                            </div>
                        </div>
